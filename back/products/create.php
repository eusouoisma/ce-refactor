<?php
    ...
    try {
        $query = "INSERT INTO `product`(`type`, `category`, `name`,`duration`) VALUES ('$type','$category','$productName','$duration')";
